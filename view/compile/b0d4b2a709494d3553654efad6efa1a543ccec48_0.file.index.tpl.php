...
<body>
                    ...
                    <div class="search-form ml-auto">
                        <div class="form-w3layouts-grid">
                            <form action="#" method="post" class="newsletter">
                                <input class="search" type="search" placeholder="Procurar" required="">
        ...
        <div class="banner-wthree-info container">
            <div class="row">
                <div class="col-lg-5 banner-left-info">
                    <h3>Bolsas  <span><br>Em geral</span></h3>
                    <a href="shop.html" class="btn shop">Veja Modelos</a>
                </div>

                <div class="col-lg-7 banner-img">
                    <img src="view/images/bag.png" alt="part image" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="mid-section">
        <div class="d-lg-flex p-0">
            <div class="col-lg-6 bottom-w3pvt-left p-lg-0">
                <img src="view/images/ab1.jpg" class="img-fluid" alt="" />
                <div class="pos-wthree">
                    <h4 class="text-wthree">tapetes de crochê </h4>
                    <a href="shop.html" class="btn shop mt-3">Shop Now</a>
                </div>
            </div>
            <div class="col-lg-6 bottom-w3pvt-left bottom-w3pvt-right p-lg-0">
                <img src="view/images/ab2.jpg" class="img-fluid" alt="" />
                <div class="pos-w3pvt">
                    <h4 class="text-w3pvt">Chinelas Bordadas<br></h4>
                    <a href="shop.html" class="btn shop mt-3">Shop Now</a>
                </div>
            </div>
        </div>
    ...
    <section class="banner-bottom py-5">
        <div class="container py-md-5">
                    ...
                    <div id="gal1" class="popup-effect">
                        <div class="popup">
                            <img src="view/images/g1.jpg" alt="Popup image" class="img-fluid mt-4" />
        ...
        <div class="shiopping-grids d-lg-flex">
            <div class="col-lg-4 shiopping-w3pvt-gd text-center">
                ...
                <div class="icon-gd-info">
                    ...
                    <p>Para qualquer compra acima de 300 R$</p>
                </div>
            </div>
            <div class="col-lg-4 shiopping-w3pvt-gd sec text-center">
                ...
                <div class="icon-gd-info">
                    <h3>Devolução</h3>
                    <p>Qualquer produto com defeito pode ser trocado por um de mesmo valor em ate 30 dias</p>
                </div>
            </div>
            <div class="col-lg-4 shiopping-w3pvt-gd text-center">
                ...
                <div class="icon-gd-info">
                    <h3>Emcomendas</h3>
                    <p>Register &amp; Acima de 10 produtos e ganho 25% de desconto avista</p>
                </div>
    ...
    <div class="footer_agileinfo_topf py-5">
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-4">
                    <ul class="footer_wthree_gridf_list">
                        ...
                        <li>
                            <a href="shop.html"><span class="fa fa-angle-right" aria-hidden="true"></span>Categorias</a>
                        </li>
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-sm-4 mt-3">
                    <ul class="footer_wthree_gridf_list">
                        ...
                        <li>
                            <a href="#"><span class="fa fa-angle-right" aria-hidden="true"></span>Termos de Uso</a>
                        </li>
                        <li>
                            <a href="login.html"><span class="fa fa-angle-right" aria-hidden="true"></span> Entrar </a>
                        </li> 
                        <li>                       
                            <a href="register.html"><span class="fa fa-angle-right" aria-hidden="true"></span>Inscreva_se</a>
                        </li>
            ...
            <div class="w3ls-fsocial-grid">
                <h3 class="sub-w3ls-headf">Siga-nós</h3>
    ...
    <div class="cpy-right text-center py-3">
        <p>© 2021 Nova Moda. All rights reserved | Design by
