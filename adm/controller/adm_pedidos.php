...
//tras todos os pedidos do banco
//$pedidos->GetPedidosCliente();

//busca os pedidos por Id de cliente
...
//faz a busca se os pedidos existem
if($pedidos->TotalDados() > 0){
    $smarty->display('adm_pedidos.tpl');
}else{
    echo'<div class="alert alert-danger">Nenhum pedido deste cliente foi encontrado</div>';
}
